<?php
/**
 * zion functions and definitions
 *
...
function zion_setup() {
	/*
		...
		* If you're building a theme based on zion, use a find and replace
		* to change 'zion' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'zion', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'zion' ),
		)
	);
 ...
 */
function zion_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'zion_content_width', 640 );
}
add_action( 'after_setup_theme', 'zion_content_width', 0 );
 ...
 */
function zion_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'zion' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'zion' ),
